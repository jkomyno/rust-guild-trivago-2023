...
* @returns {SchemaAST}
*/
module.exports.exampleSchema = function() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.exampleSchema(retptr);
...
module.exports.parseSchema = function(input) {
    try {
        ...
        wasm.parseSchema(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @param {SchemaAST} ast
*/
module.exports.validateAST = function(ast) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.validateAST(retptr, addHeapObject(ast));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
* @param {SchemaAST} ast
*/
module.exports.validateASTErrAsString = function(ast) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.validateASTErrAsString(retptr, addHeapObject(ast));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
const path = require('path').join(__dirname, 'schema_parser_wasm_bg.wasm');
